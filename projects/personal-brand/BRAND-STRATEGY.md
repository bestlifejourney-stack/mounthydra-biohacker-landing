# Todd Tzeng — Personal Brand Strategy
### Founder Advisory · Masterminds · Board of Director Engagements

*Prepared August 2026. All career claims below are sourced from Todd's own public profiles (LinkedIn, Startups.com, Clarity.fm, Health Profits Summit, Crunchbase, bestlifejourney.com) and the businesses he currently operates. Nothing is invented; open items are flagged at the end.*
...
- The track record covers the full lifecycle founders actually face: startup → growth → turnaround → M&A → IPO. That's board-seat material, not just coaching material.
- Sector depth (health & wellness, healthcare tech, fintech, e-commerce/fulfillment) maps to where independent directors are actually recruited.

**Brand voice:** Direct, numerate, unsentimental, generous. "Have opinions. Flag risks. Don't be a yes-machine." No guru language, no hustle-culture tone. Ledgers, not vision boards.

---

## 2. The three pillars (offer architecture)

### Pillar 1 — Founder Advisory (1:1)
- **Who:** Founder/CEOs roughly $1M–$50M revenue; growth-stage, stuck, or preparing for a capital event.
- **What:** Ongoing 1:1 advisory — growth strategy, unit economics, turnaround, capital strategy, exit readiness, AI-native operations.
- **Structure to consider:** Monthly retainer, quarterly commitment, small client cap (e.g., 6–8 active) to preserve scarcity and pricing power.
- **Proof assets:** track-record numbers; the live AI-agent operating model; Best Life Journey content.

### Pillar 2 — Masterminds
- **Who:** Cohorts of 6–10 non-competing founders matched by stage.
- **What:** Operator-chaired peer groups — real numbers on the table, candor over content, accountability between sessions.
- **Structure to consider:** Annual membership, monthly sessions (virtual) + 1–2 in-person intensives; premium tier with 1:1 time. Health/wellness-founder cohort is the natural first vertical given Todd's network (e.g., Health Profits Summit audience).
- **Positioning line:** "The room every founder is missing."
...
>
> What makes my advice different is that I still operate...
>
> [continue with the "record" narrative from the landing page, then the three engagement pillars, then a CTA to the page/email]

**Featured section:** pin the advisory page, one flagship post on the AI-agent operating model, and one on a turnaround lesson.

---

## 5. Content pillars (to sustain the brand)

1. **AI-native operations, from practice** — how a real company runs finance/ops/marketing on agents; "never put a human in the path of execution." This is the flagship, least-copyable pillar.
2. **Turnaround & unit-economics notes** — "double-check the math" teardowns of common growth traps.
3. **Exit & governance literacy** — what founders learn too late about M&A, boards, and going public.
4. **Best Life Journey** — the philosophy layer: building a company that serves the life, not the reverse.

Cadence that fits a 0.5-FTE reality: one substantial LinkedIn post/essay per week (agents can draft from voice notes; Todd edits — the operating model *is* the content engine).
...
| Asset | Status | Action |
|---|---|---|
| Landing page (`/advisory/`) | **Built — this repo** | Review copy, then point a proper domain at it |
| Domain | conference.mounthydra.us subpath for now | Recommend `toddtzeng.com` (or `bestlifejourney.com/advisory`) as canonical home |
| LinkedIn (linkedin.com/in/toddtzeng) | Live, outdated framing | Apply §4 refresh |
| bestlifejourney.com | Live | Cross-link to advisory page; align messaging |
| Clarity.fm / Startups.com listings | Live, legacy | Retire or repoint — hourly listings undercut board-level positioning |
| Speaking (e.g., Health Profits Summit) | Prior credential | Use bio §3-long; pursue 2–3 stages/year in health & wellness |
...
**Open items for Todd to confirm/supply:**
1. Names/dates of the two NASDAQ companies and five acquisitions — adding even one recognizable name materially strengthens board credibility.
2. Any past or current **board seats** held (the page currently claims capability, not history — first seat or existing seats should be added).
3. Preferred contact address for inquiries (page currently uses bestlifejourney@gmail.com).
4. Whether the "Todd's Zen" Medium/Tai Chi identity is his — excluded from the brand pending confirmation.
5. Headshot — the page is deliberately typographic for now; a portrait would strengthen it.
6. Canonical domain decision (toddtzeng.com recommended).
